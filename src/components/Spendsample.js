...
const Spend = ({ instance }) => {
		const spendTo = "ak_obL9nmK1QsbbkepKNimFH4LpjB6i7niwH3oxGAXXah37FFenM" ; 
            ...
            <div className="mb-4">
                ...
                <input
                    className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
										spendTo = "ak_obL9nmK1QsbbkepKNimFH4LpjB6i7niwH3oxGAXXah37FFenM"
                    value={spendTo}
										disabled={true}
                    // onChange={(e) => setSpendTo(e.target.value)}
                    // placeholder="ak_..."
										// value = "ak_obL9nmK1QsbbkepKNimFH4LpjB6i7niwH3oxGAXXah37FFenM"
                />
            </div>
            <div className="mb-4">
